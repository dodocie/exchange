...
<template>
  ...
  >
    ...
    <el-form-item label="验证码" prop="code" style="margin-bottom: 5px">
    ...
    <p class="text-xs text-red-500 mb-5 text-right">注: 当前为概念版页面，无需短信验证</p>
    <el-form-item>
      <el-button type="primary" @click="submitLoginData">登录</el-button>
