...
const handleSelect = (key: string, keyPath: Views): void => {
...
<template>
  <el-menu
    ...
    @select="handleSelect"
  >
    <div><img class="w-28 pl-4" src="@/assets/images/logo.jpg" alt="" /></div>
    <div class="grow" />
    <el-menu-item :index="ViewNames.HOME">
      <template #title>
        <el-icon><House /></el-icon>
        <span>首页</span>
      </template>
    </el-menu-item>
    <el-menu-item :index="ViewNames.PROD">
      <template #title>
        <el-icon><Shop /></el-icon>
        <span>物品</span>
      </template>
    </el-menu-item>
    <el-menu-item :index="ViewNames.PROFILE">
